...
; This file was generated Sun Nov 21 19:21:33 2010
;--------------------------------------------------------
...
;	.line	10; "main.c"	init();
	...
	PAGESEL	$
_00108_DS_
;	.line	12; "main.c"	PORTB = counter;
	BANKSEL	_counter
	MOVF	_counter,W
	BANKSEL	_PORTB
	MOVWF	_PORTB
;	.line	13; "main.c"	if(counter++>3) counter = 1;
	BANKSEL	_counter
	MOVF	_counter,W
	BANKSEL	r0x1007
	MOVWF	r0x1007
...
;unsigned compare: left >= lit(0x4=4), size=1
	...
	BTFSS	STATUS,0
	GOTO	_00106_DS_
;genSkipc:3083: created from rifx:0xbfec2264
	MOVLW	0x01
	BANKSEL	_counter
	MOVWF	_counter
_00106_DS_
;	.line	14; "main.c"	pause(30000);
	MOVLW	0x30
	MOVWF	STK00
	MOVLW	0x75
	PAGESEL	_pause
...
; 2 exit points
;	.line	20; "main.c"	void pause(unsigned int delay){
	BANKSEL	r0x1001
	MOVWF	r0x1001
	MOVF	STK00,W
	MOVWF	r0x1002
;	.line	22; "main.c"	while(now++ < delay);
	CLRF	r0x1003
	CLRF	r0x1004
_00117_DS_
	BANKSEL	r0x1003
...
;	   41+   14 =    55 instructions (  138 byte)
